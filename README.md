...
중앙 서버·POS 단말·봇 클라이언트가 REST와 SSE로 통신하는 분산 시스템을 Spring Boot 6개 모듈로 구현했습니다. 티켓 발행 동시성은 PostgreSQL 비관적 잠금으로 제어하고, 회차 생성·마감·추첨은 스케줄러로 자동화했습니다. 한국 로또 6/45를 소재로 삼았습니다.
